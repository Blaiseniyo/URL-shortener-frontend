...
const FooterLink: React.FC<FooterLinkProps> = ({ href, children }) => {
  return (
    <li>
      <a href={href} className="hover:text-cyan-400">
        {children}
      </a>
    </li>
  );
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="mb-4">
              We've been shortening URLs since 2012, helping millions of users and businesses worldwide create memorable, trackable links.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink href="#">URL Shortening</FooterLink>
              <FooterLink href="#">QR Codes</FooterLink>
              <FooterLink href="#">Link Analytics</FooterLink>
              <FooterLink href="#">Custom Domains</FooterLink>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p>© 2023 URLShort. All rights reserved.</p>
